 ...
 */
 ...
 function(file, ui, record, render, search, runtime, redirect, url) {
     ...
     function handleGET(context) {
        ...
        // get current picking list from saved search
        resultObj["pickingList"] = {};
        var thisSavedSearchId = '2096';
        ...
        var thisHtml = '<table id="dailyPicksTable">';

        // hardcoded header row for easy re-formatting
        thisHtml += '<thead><tr><th>Date</th><th>Quantity</th><th>Amount</th></tr></thead>'
